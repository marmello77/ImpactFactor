...
Let's examine the impact factor data of the journals classified in the category "Ecology" on Journal Citation Reports (JCR).
...
This is the distribution of impact factors of Biodiversity journals by discipline:
...
p2 = ggplot(jcrbio, aes(x=Journal.Impact.Factor, fill=Category)) +
  ...
  xlab("Impact factor 2019: CAPES's Biodiversity") + 
  ylab("Frequency") +
